...
<template:insert template='../template.jsp'>
  <template:put name='label' content='Categories' direct='true'/>
  <template:put name='content' direct='true'> 
		 
	 <img src="images/category-tile.gif" align="middle" border="0"><span class="titre2">Editer l'objet categorie "<bean:write name="id" scope="request"/>".</span><br><br>
	 <logic:present name="error" scope="request">
			<span class="error"><bean:write name="error" scope="request"/></span><br><br>
	 </logic:present>
	 
	 <html:form action="editCategory.x">
