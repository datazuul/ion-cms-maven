...
/**
 * <p>
 * JSP custom tag that renders a tree control represented by the <code>TreeControl</code> and
 * <code>TreeControlNode</code> classes. This tag has the following user-settable attributes:</p>
 * <ul>
 * <li><strong>action</strong> - Hyperlink to which expand/contract actions should be sent, with a string
 * "<code>${node}</code> marking where the node name of the affected node should be included.</li>
 * <li><strong>images</strong> - Name of the directory containing the images for our icons, relative to the page
 * including this tag. If not specified, defaults to "images".</li>
 * <li><strong>scope</strong> - Attribute scope in which the <code>tree</code> attribute is to be found (page, request,
 * session, application). If not specified, the attribute is searched for in all scopes.</li>
 * <li><strong>style</strong> - CSS style <code>class</code> to be applied to be applied to the entire rendered output
 * of the tree control. If not specified, no style class is applied.</li>
 * <li><strong>styleSelected</strong> - CSS style <code>class</code> to be applied to the text of any element that is
 * currently selected. If not specified, no additional style class is applied.</li>
 * <li><strong>styleUnselected</strong> - CSS style <code>class</code> to be applied to the text of any element that is
 * not currently selected. If not specified, no additional style class is applied.</li>
 * <li><strong>tree</strong> - Attribute name under which the <code>TreeControl</code> bean of the tree we are rendering
 * is stored, in the scope specified by the <code>scope</code> attribute. This attribute is required.</li>
 * </ul>
 *
...
public class TreeControlTag extends TagSupport {
    ...
    // ------------------------------------------------------------- Properties
    /**
     * The hyperlink to be used for submitting requests to expand and contract tree nodes. The placeholder
     * "<code>${name}</code>" will be replaced by the <code>name</code> property of the current tree node.
     */
    ...
    /**
     * The name of the scope in which to search for the <code>tree</code> attribute. Must be "page", "request",
     * "session", or "application" (or <code>null</code> for an ascending-visibility search).
     */
    ...
    /**
     * The CSS style <code>class</code> to be applied to the text of selected nodes.
     */
    ...
    /**
     * The CSS style <code>class</code> to be applied to the text of unselected nodes.
     */
    ...
    /**
     * The name of the attribute (in the specified scope) under which our <code>TreeControl</code> instance is stored.
     */
    ...
    // ------------------------------------------------------ Protected Methods
    /**
     * Return the <code>TreeControl</code> instance for the tree control that we are rendering.
     *
     ...
     * @param node The <code>TreeControlNode</code> we are currently rendering
    ...
    /**
     * Replace any occurrence of the specified placeholder in the specified template string with the specified
     * replacement value.
     *
